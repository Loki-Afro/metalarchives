...
public class MemberSearchParser extends AbstractSearchParser<Member> {
	...
	@Override
	protected Member useSpecificSearchParser(JSONArray hits) throws JSONException {
...
//				see FENRIZ - http://www.metal-archives.com/artists/FENRIZ/407865
	...
	private String parseRealName(String hit) {
		return hit;
	}
	...
	@Override
	protected SearchRelevance getSearchRelevance(JSONArray htis) throws JSONException {
